	...
	public Picture changeSaturation (Picture originalImg, double factor_r, double factor_g, double factor_b) {
		...
		Color colorSat = Color.GREEN;
        	...
        	for(int x=0; x < width; x++) {
				...
				colorSat = new Color(validSaturation(pixelOld[x][y].getRed(), factor_r), validSaturation(pixelOld[x][y].getGreen(), factor_r), validSaturation(pixelOld[x][y].getBlue(), factor_r));
