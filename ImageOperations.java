/**
 * Class with functions for basic image operations.
 * 
 * @author Max Wenk 
 * @version 5/15/2022
 * 
 * Funtions:
 * - mirrorHorizontal (originalImg)
 * - mirrorVertical (originalImg)
 * - turnLeft (originalImg)
 * - turnRight (originalImg)
 * - turnUpSideDown (originalImg)
 */
    ...
    public Picture turnRight (Picture originalImg) {
        ...
        for(int x=0; x < width; x++) {
            for(int y=0;y < height; y++) {
                ...
                pixelNew[y][x] = pixelOld[x][(height-1) - y];
            }
        }
